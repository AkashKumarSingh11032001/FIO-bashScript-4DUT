...
do
    ...
    fio DUT1.txt --eta-newline=1 --eta=always > ${f1} & CURR_PID=$! ; echo $CURR_PID ; prlimit --pid $CURR_PID --as=8589934592 ; cpulimit -c 8 -p $CURR_PID -l 25 &
    fio DUT2.txt --eta-newline=1 --eta=always > ${f2} & CURR_PID=$! ; echo $CURR_PID ; prlimit --pid $CURR_PID --as=8589934592 ; cpulimit -c 8 -p $CURR_PID -l 25 &
    fio DUT3.txt --eta-newline=1 --eta=always > ${f3} & CURR_PID=$! ; echo $CURR_PID ; prlimit --pid $CURR_PID --as=8589934592 ; cpulimit -c 8 -p $CURR_PID -l 25 &
    fio DUT4.txt --eta-newline=1 --eta=always > ${f4} & CURR_PID=$! ; echo $CURR_PID ; prlimit --pid $CURR_PID --as=8589934592 ; cpulimit -c 8 -p $CURR_PID -l 25 &
